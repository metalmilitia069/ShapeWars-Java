...
public class WeakEnemy extends Shape
{
	int spawnTime = 500; 
...
//		
	...
	public void DrawShape(Graphics g)
	{
		...
		g.fillRect(this.getInitialCoordinatePoint().x, this.getInitialCoordinatePoint().y, this.getShapeSize()[0], this.getShapeSize()[1]);
	}
